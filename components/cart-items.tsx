...
import type { CartEntry, Product } from 'use-shopping-cart/core';
...
export function CartItems(): JSX.Element {
	const { cartDetails, removeItem, setItemQuantity } = useShoppingCart();
	const { toast } = useToast();

	const cartItems: CartEntry[] = Object.entries(cartDetails!).map(
		([_, product]: [string, CartEntry]) => product,
	);
