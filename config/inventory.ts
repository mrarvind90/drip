...
export const inventory: InventoryProduct[] = [
	{
		...
		price: 1680, // price in the smallest currency unit (e.g. cent for USD)
		image: 'https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/canvas-tote-bag-1.jpg',
		images: [
			{
				url: 'https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/canvas-tote-bag-1.jpg',
				caption: 'Canvas tote bag side view.',
			},
			{
				url: 'https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/canvas-tote-bag-2.jpg',
				caption: 'Canvas tote bag front view.',
			},
			{
				url: 'https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/canvas-tote-bag-3.jpg',
				caption: 'Canvas tote bag top view.',
			},
		],
		sizes: ['one-size'],
		categories: ['bags'],
	...
	},
	{
		...
		images: [
			{
				url: 'https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/khaki-tote-bag-1.jpg',
				caption: 'Khaki tote bag side view.',
			},
			{
				url: 'https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/khaki-tote-bag-2.jpg',
				caption: 'Khaki tote bag front view.',
			},
			{
				url: 'https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/khaki-tote-bag-3.jpg',
				caption: 'Khaki tote bag top view.',
			},
		],
		sizes: ['one-size'],
		categories: ['bags'],
	...
	},
	{
		...
		price: 4999,
		image: 'https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/braided-leather-belt-1.jpg',
		images: [
			{
				url: 'https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/braided-leather-belt-1.jpg',
				caption: 'Brown braided leather belt.',
			},
		],
		sizes: ['s', 'm', 'l', 'xl'],
		categories: ['belts'],
	...
	},
	{
		...
		images: [
			{
				url: 'https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/woolblend-suit-belt-1.jpg',
				caption: 'Black wool blend suit belt.',
			},
		],
		sizes: ['s', 'm', 'l', 'xl'],
		categories: ['belts'],
	...
	},
	{
		...
		images: [
			{
				url: 'https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/wool-scarf-1.jpg',
				caption: 'Dark wool scarf rolled.',
			},
			{
				url: 'https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/wool-scarf-2.jpg',
				caption: 'Dark wool scarf folded.',
			},
		],
		sizes: ['one-size'],
		categories: ['scarves'],
	...
	},
	{
		...
		images: [
			{
				url: 'https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/leather-gloves-1.jpg',
				caption: 'Brown leather gloves',
			},
		],
		sizes: ['s', 'm', 'l', 'xl'],
		categories: ['gloves'],
	...
	},
	{
		...
		images: [
			{
				url: 'https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/down-mittens-1.jpg',
				caption: 'Dark down mittens.',
			},
		],
		sizes: ['s', 'm', 'l', 'xl'],
		categories: ['gloves'],
	...
	},
	{
		...
		images: [
			{
				url: 'https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/brooks-sunglasses-1.jpg',
				caption: 'Yellow Brooks sunglasses.',
			},
			{
				url: 'https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/brooks-sunglasses-2.jpg',
				caption: 'Yellow Brooks sunglasses case.',
			},
		],
		sizes: ['one-size'],
	...
	},
	{
		...
		images: [
			{
				url: 'https://fullstackdotso.nyc3.cdn.digitaloceanspaces.com/dock-sunglasses-1.jpg',
				caption: 'Dark dock sunglasses.',
			},
		],
		sizes: ['one-size'],
		categories: ['sunglasses'],
